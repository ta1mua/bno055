...
import frc.robot.utils.vision.ControlMode.Advanced_Crosshair;
import frc.robot.utils.vision.ControlMode.Advanced_Target;
import frc.robot.utils.vision.ControlMode.CamMode;
import frc.robot.utils.vision.ControlMode.LedMode;
import frc.robot.utils.vision.ControlMode.Snapshot;
import frc.robot.utils.vision.ControlMode.StreamType;
/**
...
public class LimeLight {
    ...
    private double limelightMountAngleDegrees = 36.0;
    private double limelightLensHeightCm = 60;
    private double goalHeightCm = 263.5;
